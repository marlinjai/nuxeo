...
/**
 * SCIM 2.0 /Groups endpoint error tests.
 *
 * @since 2023.13
 */
@RunWith(FeaturesRunner.class)
@Features(ScimV2Feature.class)
public class ScimV2GroupsErrorTest {
    ...
    @Test
    public void testCreateGroupNoGroupResource() {
        httpClient.buildPostRequest("/Groups") // NOSONAR
                  .executeAndConsume(new JsonNodeHandler(SC_BAD_REQUEST), ScimV2Feature::assertError);
    }

    @Test
    public void testCreateGroupAttributeUndefined() {
    ...
    public void testGetGroupNotFound() {
        httpClient.buildGetRequest("/Groups/people") // NOSONAR
                  .executeAndConsume(new JsonNodeHandler(SC_NOT_FOUND), ScimV2Feature::assertError);
    }

    @Test
    public void testUpdateGroupNoGroupResource() {
        httpClient.buildPutRequest("/Groups/people")
                  .executeAndConsume(new JsonNodeHandler(SC_BAD_REQUEST), ScimV2Feature::assertError);
    }
